...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserImageUrl = "/Assets/admin/libs/ckfinder/ckfinder.html?type=Images";
	config.filebrowserFlashUrl = "/Assets/admin/libs/ckfinder/ckfinder.html?type=Flash";
